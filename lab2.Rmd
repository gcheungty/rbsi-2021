...
- Using sample data of a list of employees from microsoft: 
[Source](https://support.microsoft.com/en-us/office/vlookup-function-0bbc8083-26fe-4963-8ab8-93a18ad188a1)
...
- There are five types of information in the data above
...
The dataset itself is a dataframe (type 7), the employees ID can be numerical (type 1), the names can be thought of characters or words (type 3). If there are a few limited categories for the job title, it can be a type of factor (type 5). We will go into these in more detail. 
...
3. String(s)/Characters & Concatenation
